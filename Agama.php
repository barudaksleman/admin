            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="utilities-color.php">Agama</a>
                        <a class="collapse-item" href="utilities-border.php">Kewarganegaraan</a>
                        <a class="collapse-item" href="utilities-animation.php">Jurusan</a>
                        <a class="collapse-item" href="utilities-other.phps">Jenjang</a>
                    </div>
                </div>
            </li>
